...
/**
 * parse_command - determinates the type of the command
 * @command: command to parse
 *
 * Return: constant of the type of the command
 *
 *		EXTERNAL_COMMAND (1) represents /bin/ls
 *		INTERNAL_COMMAND (2) represents exit, env
 *		PATH_COMMAND (3) represents ls
...
int parse_command(char *command)
{
	...
	/* @check_path - checks if a command is found n the PATH */
 ...
 *
 * Return: path where the command is found in, NULL if not
 */
...
/**
 * get_func - retrieves a function based on the command given
 * @command: strind to check agains mapping
 *
 * Return: pointer to the proper function, or null
 */
...
/**
 * _getenv - gets the value of an enviroment var
 * @name: name of the enviro var
 *
 * Return: value of the var as a string
 */
